...
```{r GSE28422}
GSE28422FO <- read.csv("microarray/GSE28422/res_GSE28422reFO.csv", header = T)
GSE28422FY <- read.csv("microarray/GSE28422/res_GSE28422reFY.csv", header = T)
GSE28422MO <- read.csv("microarray/GSE28422/res_GSE28422reMO.csv", header = T)
GSE28422MY <- read.csv("microarray/GSE28422/res_GSE28422reMY.csv", header = T)
```
...
```{r GSE117525}
GSE117525F <- read.csv("microarray/GSE117525/res_GSE117525reF.csv", header = T)
GSE117525M <- read.csv("microarray/GSE117525/res_GSE117525reM.csv", header = T)
```
