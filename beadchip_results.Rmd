...
```{r GSE58249}
GSE58249FAres <- read.csv("beadchip/GSE58249/res_GSE58249reFA.csv", header = T)
GSE58249FRres <- read.csv("beadchip/GSE58249/res_GSE58249reFR.csv", header = T)
GSE58249MAres <- read.csv("beadchip/GSE58249/res_GSE58249reMA.csv", header = T)
GSE58249MRres <- read.csv("beadchip/GSE58249/res_GSE58249reMR.csv", header = T)
```


```{r GSE58249FAres volcano}
EnhancedVolcano(GSE58249FAres,
                lab = GSE58249FAres$SYMBOL,
                # selectLab = 'Peptide9A',
                x = 'logFC',
                y = 'adj.P.Val',
                xlim = c(-2,2), ##x軸の範囲
...
```{r GSE58249FRres volcano}
EnhancedVolcano(GSE58249FRres,
                lab = GSE58249FRres$SYMBOL,
                # selectLab = 'Peptide9A',
                x = 'logFC',
                y = 'adj.P.Val',
                xlim = c(-2,2), ##x軸の範囲
...
```{r GSE58249MAres volcano}
EnhancedVolcano(GSE58249MAres,
                lab = GSE58249MAres$SYMBOL,
                # selectLab = 'Peptide9A',
                x = 'logFC',
                y = 'adj.P.Val',
                xlim = c(-2,2), ##x軸の範囲
...
```{r GSE58249MRres volcano}
EnhancedVolcano(GSE58249MRres,
                lab = GSE58249MRres$SYMBOL,
                # selectLab = 'Peptide9A',
                x = 'logFC',
                y = 'P.Value',
                xlim = c(-2,2), ##x軸の範囲
